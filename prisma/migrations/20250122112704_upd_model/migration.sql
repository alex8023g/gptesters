/*
  ...
  - You are about to drop the `InstalledApps` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "InstalledApps" DROP CONSTRAINT "InstalledApps_appId_fkey";

-- DropForeignKey
ALTER TABLE "InstalledApps" DROP CONSTRAINT "InstalledApps_userId_fkey";

-- DropTable
DROP TABLE "InstalledApps";
